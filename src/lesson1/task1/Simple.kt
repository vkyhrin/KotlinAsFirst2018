 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial*(sqr(1+percent/100.0)*(1+percent/100.0))
 ...
 */
fun numberRevert(number: Int): Int = a*number%10*100+b*number/10%10*10+c*number/100%10
var a: Int = 1
var b: Int = 1
var c: Int = 1
